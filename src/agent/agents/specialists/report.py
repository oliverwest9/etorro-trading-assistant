...
class ReportSpecialist(BaseSpecialist):
    ...
    def create_tools(self, ctx: AgentContext) -> list[Any]:
        ...
        def save_report(verbose: bool = False) -> str:
            ...
            markdown = format_markdown(report, verbose=verbose, currency_symbol=ctx.settings.currency_symbol)
        ...
        def display_report(verbose: bool = False) -> str:
            ...
            format_terminal(report, verbose=verbose, currency_symbol=ctx.settings.currency_symbol)
    ...
    def run_procedural(
        ...
        markdown = format_markdown(report, verbose=False, currency_symbol=ctx.settings.currency_symbol)
        ...
        format_terminal(report, verbose=False, currency_symbol=ctx.settings.currency_symbol)
